            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box page-title-box-alt">
                        ...
                        <h4 class="page-title">Tenant Rent Details</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="widget-chart-1">
                                ...
                                <button type="submit" class="btn btn-success btn-xs text-white modal-btn capital-w" data-toggle="modal"
                                                    data-target="=#exampleModal" style="color:#f05050">Add Property <i class="mdi mdi-domain me-1"></i>
                                </button>
                                </a>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="widget-chart-1">
                                <div class="widget-chart-box-1 float-start" dir="ltr">
                                    <input data-plugin="knob" data-width="70" data-height="70" data-fgColor="#f05050 "
                                        data-bgColor="#FF00CC" value=" 4" data-skin="tron"
                                        data-angleOffset="180" data-readOnly=true data-thickness=".15" />
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="widget-chart-1">
                                <div class="widget-chart-box-1 float-start" dir="ltr">
                                    <input data-plugin="knob" data-width="70" data-height="70" data-fgColor="#f05050 "
                                        data-bgColor="#4300A3" value=" 3" data-skin="tron"
                                        data-angleOffset="180" data-readOnly=true data-thickness=".15" />
                                </div>
                                ...
                                <a href="/tenants">
                                <button type="submit" class="btn btn-success btn-xs text-white modal-btn capital-w" data-toggle="modal"
                                                    data-target="=#exampleModal">Add Tenants <i class="mdi mdi-account-group me-1"></i>
                                </button>
                                </a>
                                </div>
                            </div>
